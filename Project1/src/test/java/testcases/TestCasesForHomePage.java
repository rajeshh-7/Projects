...
public class TestCasesForHomePage {
	...
	public void testcase1() {
		...
		homepage.clickOnImage1();

		driver.navigate().back();

		homepage.clickOnShopNewYogaBtn();
		...
		homepage.clickOnImage2();

		driver.navigate().back();

		homepage.clickOnShopPantsBtn();
		...
		homepage.clickOnImage3();

		driver.navigate().back();

		homepage.clickOnShopTeesBtn();
		...
		homepage.clickOnImage4();

		driver.navigate().back();

		homepage.clickOnShopErinRecommends();
		...
		homepage.clickOnImage5();

		driver.navigate().back();

		homepage.clickOnShopPerformanceBtn();
		...
		homepage.clickOnImage6();

		driver.navigate().back();

		homepage.clickOnShopEcoFriendlyBtn();
