...
public class TestCasesForSignIn {
	...
	public void testcase1() {
		...
		signin.setEmail("test1740@gmail.com");
		signin.setPassword("Admin@1234");
		signin.clickSignInBtn();
		signin.clickDropDown();
		signin.clickSignOut();
	...
	public void testcase2() {
		...
		signin.setEmail("test1706@gmail.com");
		signin.setPassword("Admin@1234*");
		signin.clickSignInBtn();
	...
	public void testcase7() {
		...
		signin.clickForgotYourPassword();

		WebElement resetMyPassword = driver.findElement(By.xpath("//span[text()='Reset My Password']"));

		action.moveToElement(resetMyPassword).build().perform();

		signin.setEmailAddress("test1740@gmail.com");
		signin.clickResetMyPasswordBtn();
