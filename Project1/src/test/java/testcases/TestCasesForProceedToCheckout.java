...
public class TestCasesForProceedToCheckout {
	...
	public void testcase1() throws InterruptedException {
		...
		proceedtocheckout.clickOnProduct();
		proceedtocheckout.clickOnAddToCartButton();

		Thread.sleep(5000);

		proceedtocheckout.clickOnCart();
		proceedtocheckout.clickOnProceedToCheckoutButton();
...
//	}
	...
	public void testcase2() throws InterruptedException {
		...
		proceedtocheckout.clickOnEmailAddress();
		proceedtocheckout.clickOnFirstName();
		proceedtocheckout.clickOnLastName();
		proceedtocheckout.clickOnCompany();
		proceedtocheckout.clickOnStreetAddress();
		proceedtocheckout.clickOnCity();
		proceedtocheckout.clickOnPostalCode();
		...
		proceedtocheckout.clickOnPhoneNumber();
		proceedtocheckout.clickOnNextBtn();
